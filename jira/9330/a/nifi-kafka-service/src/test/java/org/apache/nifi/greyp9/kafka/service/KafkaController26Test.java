...
import org.apache.nifi.greyp9.kafka26.KafkaController26;
...
public class KafkaController26Test {
    ...
    @Test
    public void test_1_InstantiateController26() {
        final KafkaController kafkaController = new KafkaController26();
        logger.info(kafkaController.getClass().getName());
    }

    @Test
    public void test_2_InstantiateController26Reflect() throws ReflectiveOperationException {
